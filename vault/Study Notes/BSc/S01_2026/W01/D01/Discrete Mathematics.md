...
> Primer's authors wrote every question and explanation in this note. It is not copied from a UCSC lecture, textbook, or examination.
...
- [[Study Notes/Review/Discrete Mathematics/Implication]]
- [[Study Notes/Review/Discrete Mathematics/Contrapositive]]

## Next action

Run `/probe Discrete Mathematics` and use this note as the target. Keep all generated demo work below this line or reset the file from Git when finished.
